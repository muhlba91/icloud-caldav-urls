...
public final class GUI {
	 ...
	 * @since 1.1
	 */
	private void fetchUserData(final String appleID, final String password, final String server) {
	 ...
	 * @since 1.1
	 */
	private void fireUserDataEvent(final UserData userData, final ICloudException exception) {
		progessBar.dispose();
