...
public class FormView extends JComponent {
	...
	/** The servers. */
	private static final String[] SERVERS = { "p01-caldav.icloud.com", "p02-caldav.icloud.com",
			"p03-caldav.icloud.com", "p04-caldav.icloud.com", "p05-caldav.icloud.com", "p06-caldav.icloud.com",
	...
	private void addBottomPanel() {
		...
		final JButton fetch = new JButton(new AbstractAction("Get calendar URLs") {
			private static final long serialVersionUID = 1L;
	...
	private void fireCredentialEvent() {
		final CredentialEvent e = new CredentialEvent(appleID.getText(), new String(password.getPassword()),
	...
	private void addKeyEvents() {
		...
		final KeyStroke enter = KeyStroke.getKeyStroke((char) KeyEvent.VK_ENTER);
